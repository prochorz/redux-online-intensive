...
describe("signup sage:", () => {
  describe("should pass until response received", () => {
    test("should dispatch StartFetching actions", () => {
  ...
  describe("should handle a 400 status response", () => {
    ...
    test("should dispatch stopFetching", () => {
  ...
  describe("should handle a 200 status response", () => {
    ...
    test("should dispatch fillProfile actions", () => {
...
`);
    ...
    test("should dispatch authenticate actions", () => {
...
`);
    ...
    test("should dispatch stopFetching actions", () => {
      expect(saga.next().value).toMatchInlineSnapshot(`
Object {
  "@@redux-saga/IO": true,
  "PUT": Object {
